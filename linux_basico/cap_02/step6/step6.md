...
>**Nota.** Você não precisa de um ambiente Linux para consultar o manual dos comandos.<br>
>Digite no _google_ o manual que deseja (ex.: "[man mkdir](https://www.google.com/search?q=man+mkdir))" e várias opções de sites estarão disponíveis para consulta.<br>>
